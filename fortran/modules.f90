...
!      dela = 1._dl/(NumPoints-1)
!      do ii=1, NumPointsEx-1
!        aend = dela*ii
!        grhov_t = grhov*grho_de(aend) / aend**4
!        write(50,'(100e15.6)') aend, grhob/aend**3, grhoc/aend**3, grhog/aend**4, grhov_t
!      end do
!      close(50)
